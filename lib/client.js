...
const Client = class {
    ...
    write_internal_comment(reportId, message) {

        return this.write_comment(reportId, message, true);
    }

    write_public_comment(reportId, message) {

        return this.write_comment(reportId, message, false);
    }
};
